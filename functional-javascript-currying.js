function processData(input) {
    ...
    let accelerationDueToGravity = pressure(g);     //A function which takes a single argument.
    let particleMass = accelerationDueToGravity(m);  //A function which takes a single argument.
    let particleHeight = particleMass(h);            //A function which takes a single argument.
